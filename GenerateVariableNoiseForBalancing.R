...
###
# This function generates the noise array in case of different
# colors for different variables in the amount that is needed to 
# balance the dataset. The function returns the noise array with the
# alternating selected colors of noise.
###

GenerateVariableNoiseForBalancing <- function (tbl_columns_selected, inFile,
                                               tbl_classification_columns_selected, balanced_classes, 
                                               violet_noise, blue_noise, white_noise, pink_noise, red_noise,
                                               seed, direction_of_generating) {
  ...
  # determine the amount of rows that is needed to balance the dataset (amount_of_new_rows)
  ...
  amount_of_new_rows <- sum(new_data_of_classes$Freq)
